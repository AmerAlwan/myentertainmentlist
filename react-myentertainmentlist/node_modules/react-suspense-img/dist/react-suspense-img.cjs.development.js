...
var Resource = function Resource() {
  ...
  this.read = function (src) {
    ...
    !!cachedValue ?  invariant(false, "An image was loaded that wasn't preloaded.\n" + ("Consider adding `resource.preloadImage(\"" + src + "\")`") + (" before using with <Img src=\"" + src + "\" />"))  : void 0;
...
//# sourceMappingURL=react-suspense-img.cjs.development.js.map
